        ...
        <div class="navbar navbar-fixed-top">
            ...
            <div class="container">
             ...
             if(isset($_GET['action']) == 'delete'){
				...
				$query = mysqli_query($conn, "SELECT * FROM cards WHERE id='$id_delete'");
				if(mysqli_num_rows($query) == 0){
					echo '<div class="alert alert-success alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button> No se encontraron datos.</div>';
				}else{
					$delete = mysqli_query($conn, "DELETE FROM cards WHERE id='$id_delete'");
					if($delete){
			...
			?>
                    <div class="panel panel-default">
                        ...
                        <h3 class="panel-title"><i class="icon-user"></i> datos del servidor</h3>

                        </div>

                        <div class="panel-body">
							<div class="pull-right">
								<a href="registro.php" class="btn btn-sm btn-primary">Agregar Pelicula</a>
							</div><br>
							<hr>
